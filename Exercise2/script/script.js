...
class superHeroes {
    ...
    battleMode(hero1, hero2) {
        ...
        function MakeVisible(ms) {
            ...
            hero2ABar.setAttribute("value", map_range(newTime - time1, 0, speed2 * 1000 / selectedSpeed, 0, 100));
            ...
            hero1ABar.setAttribute("value", map_range(newTime - time2, 0, speed1 * 1000 / selectedSpeed, 0, 100));
            ...
            if (hp1 <= 0) {
                ...
                winnerText.innerHTML = "Winner is " + hero2[0] + "!<br>👑👉 <br>With " + hp2 + " remaining HP!"
                winnerAnnounce.append(winnerText);
            } else if (hp2 <= 0) {
                const winnerText = document.createElement("h1");
                winnerText.innerHTML = "Winner is " + hero1[0] + "!<br>👑👈 <br>With " + hp1 + " remaining HP!"
                winnerAnnounce.append(winnerText);
    ...
    .then((json) => {
        ...
        const getHeroes = () => {
            ...
            if (selector1.value == -1 || selector2.value == -1) {
                ...
                hero1Hits.innerHTML = "Hits Delivered: 0";
                ...
                hero2Hits.innerHTML = "Hits Delivered: 0";
                ...
                heroes2get.forEach(hero => {
                    if (selector1.value == hero.id) {
                        ...
                        hero1Speed.innerHTML = "Attack Cooldown: " + map_range(hero.speed, 0, 100, 5, 1).toFixed(2) + "s";
                    ...
                    if (selector2.value == hero.id) {
                        ...
                        hero2Speed.innerHTML = "Attack Cooldown: " + map_range(hero.speed, 0, 100, 5, 1).toFixed(2) + "s";
